import instancesPathIdUniqueId from '../protocol/lib/instancesPathIdUniqueId.js'
...
export default class ProtocolInstance {
  ...
  constructor(props) {
    ...
    this._loader = loader
    this._loader._protocolInstance = this
    this._className = className
    this._params = { ...protocolPayload.params }
    this._path = protocolPayload.path
    this._id = protocolPayload.id
  ...
  get protocolPayload() {
    return this._protocolPayload
  }
  set protocolPayload(value) {
    this._protocolPayload = value
  }
  // #endregion


  toString() {
    return `ProtocolInstance: ${this.instancesPathIdString} (${this.path})`
  }
