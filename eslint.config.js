...
export default [
  ...
  jsdoc.configs['flat/recommended'],
  {
    ...
    rules: {
      ...
      // This codebase's dynamic `import()`s for CLI/protocol plugin loading are intentional -
      // n's own recommended rule already restricts this to genuinely missing files.
  ...
  {
    ignores: ['build/', 'dist/', 'types/', 'node_modules/', '.snapshots/', '**/*.min.js', 'src/_archive/**', 'src/document/**'],
  },
  prettierConfig,
]
